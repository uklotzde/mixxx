...
void BaseTrackTableModel::initTableColumnsAndHeaderProperties(
    ...
    // Init the mapping of all columns, even for internal columns that are hidden/invisible.
    // Otherwise mapColumn() would not return a valid result for those columns.
