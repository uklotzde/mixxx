...
class TrackSearchListModel : public QAbstractListModel {
  ...
  public:
    ...
    enum ItemDataRole {
        ...
        CollectedAtRole,                   // QDateTime
        ContentPathRole,                   // QString
        ContentUrlRole,                // QUrl
        ContentTypeNameRole,               // QString
        ...
        RecordedAtRole,                    // QString
        ReleasedAtRole,                    // QString
        ReleasedByRole,                    // QString
        CopyrightRole,                     // QString
  ...
  private:
    ...
    mixxx::SafeQPointer<SearchTracksTask> m_pendingTask;
};
