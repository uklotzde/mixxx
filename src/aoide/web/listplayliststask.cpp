...
const mixxx::Logger kLogger("aoide ListPlaylistsTask");
...
ListPlaylistsTask::ListPlaylistsTask(
...
void ListPlaylistsTask::onFinished(
...
void ListPlaylistsTask::emitSucceeded(
